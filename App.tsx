...
const App: React.FC = () => {
  ...
  const renderUserContent = () => {
    switch (userView) {
      ...
      case 'profile': return <Profile user={currentUser} matches={matches} onLogout={handleLogout} onLoginRequest={() => setUserView('auth')} onSettingsClick={() => setUserView('settings')} setView={setUserView} onUpdateProfile={handleUpdateProfile} setAdminMode={() => {setIsAdmin(true); setAdminView('dashboard'); setIsAdminLoggedIn(true);}} />;
